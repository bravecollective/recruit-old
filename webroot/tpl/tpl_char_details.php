...
<!-- Character -->
	...
	<tr>
	    ...
	    <?php echo "<strong>Profile:</strong> " . linkOrText($charName, "https://gate.eveonline.com/Profile/" . $charName, "EVE Gate") . ", " . linkOrText($charName, "http://evewho.com/pilot/" . $charNameUrl, "Eve Who") . "<br>"; ?>
